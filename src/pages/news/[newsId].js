...
import { UserOutlined, CalendarOutlined, CommentOutlined, ProfileOutlined } from "@ant-design/icons";
   ...
   return (
      <div>
         <Row style={{ marginTop: "80px", alignItems: "center" }}>
            <Col md={6} lg={12}>
               <Image alt="example" src={news?.image_url} width={500} height={300} responsive />
            </Col>
            <Col md={6} lg={12} style={{ paddingLeft: "20px" }}>
               ...
               <p style={{ fontSize: "25px", fontWeight: "lighter" }}>{news?.description}</p>
            </Col>
         </Row>
      </div>
   );
